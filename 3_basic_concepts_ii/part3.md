...
Each concept is introduced by showing how it fits into the totality of a python script and is accompanied by a series of exercises that make their use more clear. More thorough instructions are to be found in the [Overview](#overview) -section.
